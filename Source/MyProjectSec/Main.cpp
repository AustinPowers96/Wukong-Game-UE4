...
#include "MyProjectSecSaveGame.h"
...
void AMain::Attack()
{
	if (!bAttacking && MovementStatus != EMovementStatus::EMS_Dead)
	{
	   ...
	   if (AnimInstance && CombatMontage)
	   {
		   int32 Section = FMath::RandRange(0, 0);
		   switch (Section)
		   {
		   case 0:
...
void AMain::SaveGame()
{
	UMyProjectSecSaveGame* SaveGameInstance = Cast<UMyProjectSecSaveGame>(UGameplayStatics::CreateSaveGameObject(UMyProjectSecSaveGame::StaticClass()));
...
{
	UMyProjectSecSaveGame* LoadGameInstance = Cast<UMyProjectSecSaveGame>(UGameplayStatics::CreateSaveGameObject(UMyProjectSecSaveGame::StaticClass()));

	LoadGameInstance = Cast<UMyProjectSecSaveGame>(UGameplayStatics::LoadGameFromSlot(LoadGameInstance->PlayerName, LoadGameInstance->UserIndex));
